                ...
                children: [
                  Expanded(
                    child: CustomTextFormField(
                      ...
                      onChange: (value) {
                        final parsed = int.tryParse(value.trim());
                        if (parsed != null) {
                          ref.read(timeNumberProvider.notifier).state = parsed;
                        }
                      },
                      prefixOntap: () {
                        if (timeNumber > 15) {
                  ...
                  Expanded(
                    child: CustomTextFormField(
                      ...
                      onTap: () {
                        ref.read(maxMarkProvider.notifier).state = maxMark + 1;
              ...
              CustomButtonWIdget(
                ...
                onTap: () async {
                  ...
                  if (ref.watch(paperTypeOptionProvider) ==
                    ...
                    const propmt = """
     Generate an exam paper on 'flutter'
              Difficulty: hard.
