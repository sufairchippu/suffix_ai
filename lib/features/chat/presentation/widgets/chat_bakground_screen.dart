...
class _GradientMotionBackgroundState extends State<GradientMotionBackground>
  ...
  Widget build(BuildContext context) {
    ...
    final color1 = AppColors.dynamicColor1.resolveFrom(context);
    final color2 = AppColors.dynamicColor2.resolveFrom(context);
    final color3 = AppColors.dynamicColor3.resolveFrom(context);
